...
public class Main {
    ...
    //Ответ:так как shutdown упорядоченно завершает работу потоков, при этом новые задачи для потоков
    //браться не будут и это значит, что все потоки после закончат работу, текущей задачи и умрут
